...
imports <- read.csv(paste0(data_dir,"RmovePackages-ImportSuggest.csv"),stringsAsFactors = FALSE)
...
imports <- read.csv(paste0(data_dir,"RmovePackages-Import.csv"),stringsAsFactors = FALSE) # we need an only import file 
