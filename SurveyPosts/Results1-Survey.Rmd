...
```{r documentation percentage, echo=FALSE, message=F, fig.width=16, fig.height=10, fig.cap="Figure 4. Bar plots of relative frequency of each category of package documentation"}
...
```{r importance percentage, echo=FALSE, message=F,fig.width=16, fig.height=10, fig.cap="Figure 6. Bar plots of relative frequency of each category of package relevance"}
