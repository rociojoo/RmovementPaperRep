...
\item The advent of miniaturized biologging devices has provided ecologists with unparalleled opportunities to record animal movement across scales, and led to the collection of ever-increasing quantities of tracking data. In parallel, sophisticated tools to process, visualize and analyze tracking data have been developed in abundance. Within the R software alone, we listed \textcolor{blue}{57} tracking packages. 
  ...
  \item Finally, we provide recommendations for users to choose packages, and for developers to maximize usefulness of their contribution and strengthen the links between the programming community. %MB: But see Susana's comments about 'recommendations for users to choose packages'.
  \end{enumerate}
\end{abstract}
...
%MB: My attempt to beef up a bit the idea of classes… Not sure if this should go here or better in the discussion. What is possible is that reviewers actually underline that this part does not flow very well, or needs more details… which would give another opportunity to make it better.
...
%MB: References:
% 
% - Calenge, Clément, Dray, Stéphane, & Royer-Carenzi,
%   M. (2009). The concept of animals' trajectories from a data analysis
%   perspective. Ecological Informatics, 4,
%   34–41. http://dx.doi.org/10.1016/j.ecoinf.2008.10.002
%   
% - Turchin, P. (1998). Quantitative analysis of movement: measuring and
%   modeling population redistribution in animals and
%   plants. Sunderland, MA, USA: Sinauer Associates.
